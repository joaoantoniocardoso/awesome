...
-- https://awesome.naquadah.org/wiki/Transparency
run_once("unagi &")
...
modkey     = "Mod4"
altkey     = "Mod1"
terminal   = "termite" or "urxvtc" or "xterm"
editor     = os.getenv("EDITOR") or "nano" or "vim" or "" or "vi"
...
tags = {
   names = { "1", "2", "3", "4", "5", "6", "7"},
   layout = { layouts[1], layouts[2], layouts[3], layouts[1], layouts[4], layouts[4], layouts[4] }
}
...
-- Battery by github.com/joaoantoniocardoso
...
globalkeys = awful.util.table.join(
    ...
    -- Displays information about layout of current tag when it changes. Ref: https://awesome.naquadah.org/wiki/Layout
  ...
  awful.key({ modkey, "Shift"   }, "space", function () awful.layout.inc(layouts, -1)
    ...
    awful.key({ altkey }, "XF86AudioLowerVolume",
        function ()
            os.execute(string.format("amixer -c %s set %s 75%%", volumewidget.card, volumewidget.channel))
            volumewidget.update()
        end),

  -- Backlight control, by github.com/joaoantoniocardoso
  awful.key({ }, "XF86MonBrightnessDown",
    function ()
      if tonumber(awful.util.pread("xbacklight")) > 0 then 
        awful.util.spawn("xbacklight -dec 10")
      end
  end),
  awful.key({ }, "XF86MonBrightnessUp",
    function ()
      if tonumber(awful.util.pread("xbacklight")) < 100 then 
    ...
    awful.key({ modkey, "altkey" }, "q", function () awful.util.spawn(browser3) end),
    awful.key({ modkey }, "s", function () awful.util.spawn(gui_editor) end),
    -- awful.key({ modkey }, "g", function () awful.util.spawn(graphics) end),
    awful.key({ modkey }, "e", function () awful.util.spawn(file_nav) end),
...
clientkeys = awful.util.table.join(
    ...
    -- Dynamically Changes Transparency, note that it needs some Composer, by github.com/joaoantoniocardoso
    awful.key({ modkey,           }, ".",
    function (c)
      if c.opacity < 1 then
